...
import bo.edu.ucb.Internship.backend.dao.RepresentativeRepository;
import bo.edu.ucb.Internship.backend.entity.Representative;


@Service
public class RepresentativeBl implements RepresentativeRepository {

    @Autowired
    RepresentativeRepository representativeRepository;

    public RepresentativeBl(RepresentativeRepository representativeRepository) {
    ...
    @Override
    public Representative getOne(Integer id) {
    ...
    @Override
    public Representative getReferenceById(Integer id) {
    ...
    @Override
    public List<Representative> findAllById(Iterable<Integer> ids) {
         
        throw new UnsupportedOperationException("Unimplemented method 'findAllById'");
    }

    @Override
    public <S extends Representative> S save(S entity) {
         
        throw new UnsupportedOperationException("Unimplemented method 'save'");
    }

    @Override
    public Optional<Representative> findById(Integer id) {
    ...
    @Override
    public <S extends Representative, R> R findBy(Example<S> example,
